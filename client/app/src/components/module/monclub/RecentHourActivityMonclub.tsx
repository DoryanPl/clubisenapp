...
export default function RecentHourActivityMonclub(props: ClubID) {
  ...
  return (
    <Card className="bg-primary/90 border border-default-200 shadow-sm dark:shadow-xl">
      <CardBody className="gap-4 p-3 sm:p-6">
        ...
        <SectionTitle icon={<History size={16} className="sm:w-5 sm:h-5" />} title="Heures d'activité récente" />
