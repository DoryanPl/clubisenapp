          ...
          <CardBody className="p-6 flex flex-col items-center gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-secondary font-medium flex items-center justify-center gap-2 mt-2">
                    ...
                    {membre.clubNom && (
                      <span className="px-2 py-1 rounded-full bg-content2 text-foreground text-sm font-semibold">
                        {membre.clubNom}
                      </span>
                    )}
                    {membre.role && (
                      <span className="px-2 py-1 rounded-full bg-secondary text-background font-semibold text-sm font-semibold">
                        {membre.role}
                      </span>
                    )}
                </p>
